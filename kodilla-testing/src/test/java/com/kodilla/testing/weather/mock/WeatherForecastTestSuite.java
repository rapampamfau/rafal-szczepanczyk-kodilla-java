...
@DisplayName("Tests for Weather Forecast")
public class WeatherForecastTestSuite {
    ...
    @Test
    @DisplayName("Test for weather forecast using mock")
    ...
    @Test
    @DisplayName("Test for average temperature using mock")
    ...
    @Test
    @DisplayName("Test for median temperature using mock")
