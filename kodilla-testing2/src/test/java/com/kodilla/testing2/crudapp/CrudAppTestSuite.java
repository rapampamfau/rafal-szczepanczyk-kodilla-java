...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://rapampamfau.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("rafal.szczepanczyk7@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("L=(yCp+e6!?9hLR");
    ...
    private void deleteCreatedTask(String taskName) throws InterruptedException {
        driver.findElements(
                By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(p -> p.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                        .getText().equals(taskName))
                .forEach(theForm -> {
